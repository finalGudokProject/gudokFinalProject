        ...
        <hr style="border-color:rgb(0, 125, 255);">
            ...
            <form>
              <table style="margin-top:15px">
                  <tbody >
                    <tr>
                      <th style="width:15%; padding:20px; text-align: center;">제안유형</th>
                      <td style="text-align: center;" colspan="3"> 베이커리</td>
                  </tr>
                  <tr>
                      <th style="width:15%; padding:20px; text-align: center;">제목</th>
                      <td style="text-align: center;" colspan="3">괴라는 나물</td>
                  </tr>
                  <tr>
                      <th style="width:15%; padding:20px; text-align: center;">작성자</th>
                      <td style="text-align: center;">클템</td>
                      <th style="width:20%; padding:20px; text-align: center;">답변여부</th>
                      <td style="text-align: center;">N</td>
                  </tr>
                              <tr>
                                <td colspan="4" style="height:auto; padding:5%">
                                  <span style="margin:auto">쓰레기야!
                                  </span>
                                  <br><br>
                                  <center>
                ...
                <table style="margin-top:15px">
                  <tr>
                    ...
                    <td colspan="3"><textarea class="form-control" rows="5" style="resize: none;"></textarea></td>
                  </tr>
                </table>
    </form>
    </form>
            <br><br>
            &nbsp;&nbsp;<a href="ad_proposal.html" type="button" class="btn btn-primary" style="float:right;">목록으로</a>
            <input type="submit" value="등록" class="btn btn-primary" style="float:right; margin-right: 10px;">
            <br><br><br>
