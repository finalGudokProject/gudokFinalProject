  ...
  <body>
    ...
    <div class="content">
      <div class="container box">
        ...
        <thead>
          <tr>
            <th><input type="checkbox"></th><th style="width:10%">번호</th><th style="width:55%">제목</th><th style="width:20%">작성일</th><th style="width:10%">조회수</th>
          </tr>
        </thead>
        <tbody >
          <tr>
            <th><input type="checkbox"><td>1</td><td>공지사항</td><td>2020.08.04</td><td>0</td>
          </tr>
          <tr>
            <th><input type="checkbox"><td>1</td><td>공지사항</td><td>2020.08.04</td><td>0</td>
          </tr>
          ...
          <tr>
            ...
            <br><br>
            &nbsp;&nbsp;<a href="ad_notice_detail.html" type="button" class="btn btn-primary" style="float:right;">글쓰기</a> 
