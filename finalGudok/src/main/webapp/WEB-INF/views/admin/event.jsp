...
<body>
    ...
    <div class="content">
      <div class="container box">
        ...
        <thead>
          <tr>
            <th><input type="checkbox"></th><th style="width:10%">번호</th><th style="width:45%">제목</th><th style="width:20%">작성일</th><th style="width:10%">조회수</th><th >게시여부</th>
          </tr>
        </thead>
        <tbody >
          <tr>
            <th><input type="checkbox"></th><td>1</td><td>이벤트</td><td>2020.08.04</td><td>0</td><td>Y</td>
          </tr>
          <tr>
            <th><input type="checkbox"></th><td>1</td><td>이벤트</td><td>2020.08.04</td><td>0</td><td>Y</td>
          </tr>
          ...
          <tr>
            <th><input type="checkbox"></th><td>1</td><td>이벤트</td><td>2020.08.04</td><td>0</td><td>N</td>
          </tr>
          <tr>
            <th><input type="checkbox"></th><td>1</td><td>이벤트</td><td>2020.08.04</td><td>0</td><td>N</td>
          </tr>
          ...
          <tr>
            ...
            <input type="submit" value="게시여부 변경" class="btn btn-primary" style="float:right; margin-right: 10px;">
            <br><br><br>
