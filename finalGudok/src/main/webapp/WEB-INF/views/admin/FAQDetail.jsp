    ...
    <div class="content">
      <div class="container box">
        ...
        <hr style="border-color:rgb(0, 125, 255);">
            ...
            <form>
              <table style="margin-top:15px">
                <thead style="text-align: center;">
                  <tr>
                    <th style="width:5%; padding:20px;">제목</th><td style="width: 35%;">FAQ</td><th style="width: 10%;">작성일</th><td style="width: 10%;">2020.08.05</td>
                  </tr>
                </thead>
                <tbody >
                  <tr>
            ...
            <a href="ad_FAQ_write.html" type="button" class="btn btn-primary" style="float:right;margin-right:10px">수정</a>
