        ...
        <hr style="border-color:rgb(0, 125, 255);">
            ...
            <form>
                ...
                <thead style="text-align: center;">
                  <tr>
                    <th style="width:10%; padding:20px;">이벤트</th><td style="width: 35%;">이벤트</td><th style="width: 10%;">작성일</th><td style="width: 10%;">2020.08.05</td><th style="width: 10%;">게시여부</th><td style="width: 10%;">Y</td>
                  </tr>
                </thead>
                <tbody >
                  <tr>
