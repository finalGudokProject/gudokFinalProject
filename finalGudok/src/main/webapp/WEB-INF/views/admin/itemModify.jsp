            ...
            <div class="container box">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td id="td2">
                            <input type="radio" name="posted" value="Y">&nbsp;게시 &nbsp; &nbsp; &nbsp;
                            <input type="radio" name="posted" value="N">&nbsp;중지
                        </td>
                        <td id="td3">
                            이벤트 여부
                        </td>
                        <td id="td4">
                            <input type="radio" name="eventP" value="Y">&nbsp;O &nbsp; &nbsp; &nbsp;
                            <input type="radio" name="eventP" value="N">&nbsp;X 
