...
<div class="container">
	...
	<c:choose>
		<c:when test="${!empty dList}">
			<c:forEach var="i" items="${dList }" varStatus="vs">
				<c:url var="idetail" value="idetail.do">
					<c:param name="itemNo" value="${i.itemNo }"/>
					<c:param name="page" value="${dPi.currentPage }"/>
		...
		<c:when test="${!empty mList}">
			<c:forEach var="i" items="${mList }" varStatus="vs">
				<c:url var="idetail" value="idetail.do">
					<c:param name="itemNo" value="${i.itemNo }"/>
					<c:param name="page" value="${mPi.currentPage }"/>
					<c:param name="memberNo" value="${loginUser.memberNo }"/>
				</c:url>
				<fmt:formatNumber var="discountPrice" value="${(i.itemPrice - i.itemPrice*(i.itemDiscount/100))}" type="number"/>
				<fmt:formatNumber var="itemPrice" value="${i.itemPrice}" type="number"/>
		...
		<c:when test="${!empty bList}">
			<c:forEach var="i" items="${bList }" varStatus="vs">
				<c:url var="idetail" value="idetail.do">
					<c:param name="itemNo" value="${i.itemNo }"/>
					<c:param name="page" value="${bPi.currentPage }"/>
					<c:param name="memberNo" value="${loginUser.memberNo }"/>
				</c:url>
				<fmt:formatNumber var="discountPrice" value="${(i.itemPrice - i.itemPrice*(i.itemDiscount/100))}" type="number"/>
				<fmt:formatNumber var="itemPrice" value="${i.itemPrice}" type="number"/>
		...
		<c:when test="${!empty sList}">
			<c:forEach var="i" items="${sList }" varStatus="vs">
				<c:url var="idetail" value="idetail.do">
					<c:param name="itemNo" value="${i.itemNo }"/>
					<c:param name="page" value="${sPi.currentPage }"/>
					<c:param name="memberNo" value="${loginUser.memberNo }"/>
				</c:url>
				<fmt:formatNumber var="discountPrice" value="${(i.itemPrice - i.itemPrice*(i.itemDiscount/100))}" type="number"/>
				<fmt:formatNumber var="itemPrice" value="${i.itemPrice}" type="number"/>
		...
		<c:when test="${!empty hList}">
			<c:forEach var="i" items="${hList }" varStatus="vs">
				<c:url var="idetail" value="idetail.do">
					<c:param name="itemNo" value="${i.itemNo }"/>
					<c:param name="page" value="${hPi.currentPage }"/>
					<c:param name="memberNo" value="${loginUser.memberNo }"/>
				</c:url>
				<fmt:formatNumber var="discountPrice" value="${(i.itemPrice - i.itemPrice*(i.itemDiscount/100))}" type="number"/>
				<fmt:formatNumber var="itemPrice" value="${i.itemPrice}" type="number"/>
		...
		<c:when test="${!empty diList}">
			<c:forEach var="i" items="${diList }" varStatus="vs">
				<c:url var="idetail" value="idetail.do">
					<c:param name="itemNo" value="${i.itemNo }"/>
					<c:param name="page" value="${diPi.currentPage }"/>
					<c:param name="memberNo" value="${loginUser.memberNo }"/>
				</c:url>
				<fmt:formatNumber var="discountPrice" value="${(i.itemPrice - i.itemPrice*(i.itemDiscount/100))}" type="number"/>
				<fmt:formatNumber var="itemPrice" value="${i.itemPrice}" type="number"/>
